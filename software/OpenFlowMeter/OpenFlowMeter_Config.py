...
class OpenFlowMeter_Config(object):
    ...
    def fromBytes(self, bytesin=[]):
        ...
        self.PID_T[0] = np.frombuffer(bytesin[ 6: 7], dtype=np.float16)[0]
        self.PID_P[0] = np.frombuffer(bytesin[ 8: 9], dtype=np.float16)[0]
        self.PID_I[0] = np.frombuffer(bytesin[10:11], dtype=np.float16)[0]
        self.PID_D[0] = np.frombuffer(bytesin[12:13], dtype=np.float16)[0]
        self.PID_T[1] = np.frombuffer(bytesin[14:15], dtype=np.float16)[0]
        self.PID_P[1] = np.frombuffer(bytesin[16:17], dtype=np.float16)[0]
        self.PID_I[1] = np.frombuffer(bytesin[18:19], dtype=np.float16)[0]
        self.PID_D[1] = np.frombuffer(bytesin[20:21], dtype=np.float16)[0]
